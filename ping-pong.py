...
#implementing the function fro moving 
def padle_L_up():
    y= left_paddle.ycor()
    y += 20
    left_paddle.sety(y)
...
#binding key form moving the paddles

screen_1.listen()
screen_1.onkeypress(padle_L_up, "w")
screen_1.onkeypress(padle_R_up, "Up")
screen_1.onkeypress(padle_L_down, "s")
screen_1.onkeypress(padle_R_down, "Down")
...
while True:
    ...
    if hit_ball.xcor() < -500:
        ...
        sketch_1.clear()
        sketch_1.write(
            "Left_player: {} Right_player: {}".format(left_player, right_player), align="center", font= ("Courier", 24, "normal")
        )
